...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		//==================================================
		var that = this;
		var displayWidth = stage.canvas.width;
		var displayHeight = stage.canvas.height;
...
// stage content:
(lib.jugglespyrov13html5 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_1 = function() {
		...
		function exportPNG() {
			...
			var BitmapDataExport = new createjs.BitmapData(null, displayWidth/stage.scaleX, displayHeight/stage.scaleY, backgroundColor);
			...
			axisDisplay.filters = [];
			axisDisplay.cache(0, 0, displayWidth/stage.scaleX, displayHeight/stage.scaleY);
			BitmapDataExport.draw(axisDisplay)
			axisDisplay.removeChild(right_axisShapeClone);
			axisDisplay.removeChild(left_axisShapeClone);
			axisDisplay.uncache();
		
			BitmapDataExport.draw(right_armBitmapData);
			BitmapDataExport.draw(right_propPathBitmapData);
			BitmapDataExport.draw(right_objBitmapData);	
			...
			right_objHandleDisplay.cache(0, 0, displayWidth/stage.scaleX, displayHeight/stage.scaleY);
			...
			BitmapDataExport.draw(left_armBitmapData);
			BitmapDataExport.draw(left_propPathBitmapData);
			BitmapDataExport.draw(left_objBitmapData);
			...
			left_objHandleDisplay.cache(0, 0, displayWidth/stage.scaleX, displayHeight/stage.scaleY);
		...
		function cloneCanvas(oldCanvas) {
		    ...
		    context.drawImage(oldCanvas,0,0,displayWidth/stage.scaleX,displayHeight/stage.scaleY,0,0,GIFWidth,GIFHeight);	
		    return newCanvas;
		}
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_1hand.png?1594767008022", id:"_1hand"},
		{src:"images/_1hand_grey.png?1594767008022", id:"_1hand_grey"},
		{src:"images/_2handssync.png?1594767008022", id:"_2handssync"},
		{src:"images/_2handssync_grey.png?1594767008022", id:"_2handssync_grey"},
		{src:"images/clean.png?1594767008022", id:"clean"},
		{src:"images/ColorWheel.png?1594767008022", id:"ColorWheel"},
		{src:"images/creditsimg.png?1594767008022", id:"creditsimg"},
		{src:"images/help.png?1594767008022", id:"help"},
		{src:"images/info.png?1594767008022", id:"info"},
		{src:"images/pause.png?1594767008022", id:"pause"},
		{src:"images/photo.png?1594767008022", id:"photo"},
		{src:"images/play.png?1594767008022", id:"play"},
		{src:"images/reset.png?1594767008022", id:"reset"},
		{src:"images/save.png?1594767008022", id:"save"},
		{src:"images/start_record.png?1594767008022", id:"start_record"},
		{src:"images/stop.png?1594767008022", id:"stop"},
		{src:"images/stop_record.png?1594767008022", id:"stop_record"},
		{src:"images/target.png?1594767008022", id:"target"},
		{src:"images/videorandom.png?1594767008022", id:"videorandom"},
		{src:"images/videoXML.png?1594767008022", id:"videoXML"},
		{src:"images/videoXMLfile.png?1594767008022", id:"videoXMLfile"},
		{src:"components/lib/jquery-3.4.1.min.js?1594767008022", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1594767008022", id:"sdk/anwidget.js"},
		{src:"components/ui/src/textinput.js?1594767008022", id:"an.TextInput"},
		{src:"components/ui/src/combobox.js?1594767008022", id:"an.ComboBox"},
		{src:"components/ui/src/checkbox.js?1594767008022", id:"an.Checkbox"}
	],
	preloads: []
};
